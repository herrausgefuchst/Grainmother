 ...
 *
 * The `Menu` class handles the initialization, navigation, and interaction within a dynamic menu system.
 * It supports scrolling, button interactions, preset loading/saving, and dynamic page management.
 */
