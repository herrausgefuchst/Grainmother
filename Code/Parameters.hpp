...
public:
    ...
    /** Connects a Midi CC Index to this parameter, by default it is 0 */
    ...
    /** Recevies a midi value (0...127) and sets the parameter correspondingly */
    ...
    /** Connects a pointer to the currently displayed parameter, needed for comparison to this parameter, if no parameter is displayed, the pointer is nullptr */
    ...
    /** Gets the coupled midi CC index, if not connected, it returns 0 */
...
protected:
    ...
    uint ccIndex = 0; /**< The mici CC index */
    const String id; /**< The ID of the parameter */
    const String name; /**< The name of the parameter */
    AudioParameter** displayedParameter = nullptr; /**< pointer to the currently displayed parameter */
};
...
public:
    ...
    /**
     * @brief Handles MIDI changes from a connected device
     * @param ccValue_ the new cc value (0...127)
     */
...
public:
    ...
    /**
     * @brief Returns a parameter by its CC Index
     * @param ccIndex_ the cc Index that we search for
     * @return A pointer to the requested AudioParameter, if not found returns nullptr
     */
